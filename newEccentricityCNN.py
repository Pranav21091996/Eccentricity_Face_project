...
num_crops = 4
dataSet_directory = 'Dataset100Class/Original'
InputImage = []
Labels = []
i=0
...
def one_hot_encode(x):
	...
	return x
np.save('Eccentricity_Input',InputImage)
np.save('Eccentricity_Input_Labels',Labels)
...
def maxpool3d(conv,pool_ksize,pool_strides):
...
#	conv2 = maxpool3d(conv2,pool_ksize,pool_strides)
