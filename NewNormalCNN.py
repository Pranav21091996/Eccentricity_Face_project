...
for ImageDir in os.listdir(dataSet_directory):
    image_directory = dataSet_directory+'/'+ImageDir+'/'+'images'
...
BATCH_SIZE = 64
DISPLAY_STEP = 10
#np.save('Class100NormalImage',InputImage)
#np.save('Class100NormalImageLabels',Labels)
...
def maxpool2d(conv,pool_ksize,pool_strides):
...
def conv_net(x, keep_prob):
    ...
    conv = conv2d(x_tensor,conv_num_outputs,conv_ksize,conv_strides,pool_ksize,pool_strides)
    #conv = maxpool2d(conv,pool_ksize,pool_strides)

    conv_num_outputs = 256
    conv2 = conv2d(conv,conv_num_outputs,conv_ksize,conv_strides,pool_ksize,pool_strides)
    #conv2 = maxpool2d(conv2,pool_ksize,pool_strides)

    conv_num_outputs = 256
    conv3 = conv2d(conv2,conv_num_outputs,conv_ksize,conv_strides,pool_ksize,pool_strides)
    conv3 = maxpool2d(conv3,pool_ksize,pool_strides)


    conv_num_outputs = 256
    conv4 = conv2d(conv3,conv_num_outputs,conv_ksize,conv_strides,pool_ksize,pool_strides)
    conv4 = maxpool2d(conv4,pool_ksize,pool_strides)


    conv_num_outputs = 256
    conv5 = conv2d(conv4,conv_num_outputs,conv_ksize,conv_strides,pool_ksize,pool_strides)
    conv5 = maxpool2d(conv5,pool_ksize,pool_strides)
